...
![Formulario concessionaria](./3_Semestre/form_concessionaria.png)

- Formulario Unidade

![Formulario Unidade](./3_Semestre/form_unidade.png)

- Contrato Agua

![Contrato Agua](./3_Semestre/contrato_agua.png)

- Contrato Energia

![Contrato Energia](./3_Semestre/contrato_energia.png)

- Conta Agua

![Conta Agua](./3_Semestre/pt1_conta_agua.png)
![Conta Agua](./3_Semestre/pt2_conta_agua.png)

- Conta Energia

![Conta Energia](./3_Semestre/pt1_conta_energia.png)
![Conta Energia](./3_Semestre/pt2_conta_energia.png)

- Quadro Concessionaria

![Quadro Concessionaria](./3_Semestre/quadro_concessionaria.png)

- Modal Quadro Concessionaria

![Quadro Concessionaria](./3_Semestre/quadro_concessionaria_read.png)

- Modal Quadro Concessionaria Update

![Quadro Concessionaria](./3_Semestre/quadro_concessionaria_update.png)

- Quadro Unidade

![Quadro Unidade](./3_Semestre/quadro_unidade.png)

- Modal Quadro Unidade

![Modal Quadro Unidade](./3_Semestre/quadro_unidade_read.png)

- Modal Quadro Unidade Update

![Modal Quadro Unidade](./3_Semestre/quadro_unidade_update.png)

- Quadro Contrato Agua

![Modal Quadro Agua](./3_Semestre/quadro_contrato_agua.png)

- Modal Quadro Contrato Agua

![Modal Quadro Agua](./3_Semestre/quadro_contrato_agua_read.png)

- Modal Quadro Contrato Agua Update

![Modal Quadro Agua Update](./3_Semestre/quadro_contrato_agua_update.png)

- Quadro Contrato Energia

![Modal Quadro Energia](./3_Semestre/quadro_contrato_energia.png)

- Modal Quadro Contrato Energia

![Modal Quadro Energia](./3_Semestre/quadro_contrato_energia_read.png)

- Modal Quadro Contrato Energia Update

![Modal Quadro Energia](./3_Semestre/quadro_contrato_energia_update.png)

- Tela Login

![Tela Login](./3_Semestre/tela_login.png)

- Alertas de Consumo

![Alertas de Consumo](./3_Semestre/alertas_de_consumo.png)

- Relatório de Contas Agua

![Relatório de Contas Agua](./3_Semestre/relatorio_contas_agua.png)

- Gráfico Consumo Mês Agua

![Gráfico Consumo Mês Agua](./3_Semestre/grafico_consumo_mes_agua.jpeg)

- Gráfico Valor Total Mês Agua

![Gráfico Valor Total Mês Agua](./3_Semestre/grafico_valor_total_mes_agua.png)

- Relatório de Contas Energia

![Relatório de Contas Energia](./3_Semestre/relatorio_contas_energia.png)

- Gráfico Consumo Mês Energia

![Gráfico Consumo Mês Energia](./3_Semestre/grafico_consumo_mes_energia.png)

- Gráfico Valor Total Mês Energia

![Gráfico Valor Total Mês Energia](./3_Semestre/grafico_valor_total_mes_energia.png)
...
![Gráfico](./3_Semestre/relatorios_e_graficos.gif)
